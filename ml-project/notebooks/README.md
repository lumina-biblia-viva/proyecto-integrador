...
```shell
python3 -m ipykernel install --user --name "lumina_ml"
```

Afterwards a new kernel called lumina_ml should be available
...
This should allow you to directly import `src/lumina_ml`
in your notebook.
